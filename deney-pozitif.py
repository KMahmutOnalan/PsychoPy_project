...
expName = 'deney-pozitif'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\isa.cakir\\Desktop\\deney-negatif\\deney-pozitif.py',
...
duygu1 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('duygusorular.xlsx', selection='1'),
...
for thisDuygu1 in duygu1:
    ...
    for thisComponent in duygularComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    #duygular.extend(int(thisTrials.data["slider.response"]))
...
brsi1 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('bsri.xlsx', selection='1'),
...
navonblok2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('navon.xlsx', selection='1'),
...
cattelll = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('cattellfalse.xlsx', selection='7:14'),
...
cattell2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('cattell2false.xlsx', selection='7:14'),
...
hataloop = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('hataruminasyon.xlsx', selection='1'),
...
for thisToplamlar in toplamlar:
    ...
    duygufark = subtract(duygu1.data["slider.response"], duygu2.data["slider.response"]).tolist()
    toplamlar.addData("duygu fark", duygufark)
    rumifark = subtract(brsi1.data["slider_2.response"], brsi2.data["slider_2.response"]).tolist()
    toplamlar.addData("ruminasyon fark", rumifark)
