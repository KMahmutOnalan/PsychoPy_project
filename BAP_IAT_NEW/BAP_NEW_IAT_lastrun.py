...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PychComp\\Desktop\\BAP_IAT_NEW\\BAP_NEW_IAT_lastrun.py',
...
def setupWindow(expInfo=None, win=None):
    ...
    if win is None:
        ...
        win = visual.Window(
            ...
            monitor='expMonitor', color=[1.0000, 1.0000, 1.0000], colorSpace='rgb',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_blok1_instruction1 = visual.TextStim(win=win, name='text_blok1_instruction1',
        text='Başı örtüsüz yüzler için E kullanılacak. \n\nBaşı örütülü yüzler için I kullanılacak.\n\nEğer cevabınız yanlış ise siyah "X" işaretiyle karşılacaksınız. Doğru yaptığınız zaman bir sonraki denemeye geçeceksiniz ! \n\n\nBaşlamak için boşluk tuşuna basın',
        font='Open Sans',
    ...
    for thisCondition1 in condition1:
        ...
        # save data for this loop
        loop_block1.saveAsExcel(filename + '.xlsx', sheetName='loop_block1',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_block2.saveAsExcel(filename + '.xlsx', sheetName='loop_block2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_block3.saveAsExcel(filename + '.xlsx', sheetName='loop_block3',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_block4 in loop_block4:
            ...
            # save data for this loop
            trials_14.saveAsExcel(filename + '.xlsx', sheetName='trials_14',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_block4.saveAsExcel(filename + '.xlsx', sheetName='loop_block4',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_blok5 in loop_blok5:
            ...
            for thisTrial_12 in trials_12:
                ...
                # save data for this loop
                trials_15.saveAsExcel(filename + '.xlsx', sheetName='trials_15',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_blok5.saveAsExcel(filename + '.xlsx', sheetName='loop_blok5',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
    ...
    # save data for this loop
    condition1.saveAsExcel(filename + '.xlsx', sheetName='condition1',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    ...
    for thisCondition2 in condition2:
        ...
        for thisLoop_blok4_2 in loop_blok4_2:
            ...
            # save data for this loop
            trials_16.saveAsExcel(filename + '.xlsx', sheetName='trials_16',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            for thisTrial_18 in trials_18:
                ...
                # save data for this loop
                trials_17.saveAsExcel(filename + '.xlsx', sheetName='trials_17',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            # save data for this loop
            trials_18.saveAsExcel(filename + '.xlsx', sheetName='trials_18',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_blok4_2.saveAsExcel(filename + '.xlsx', sheetName='loop_blok4_2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_blok2_2 in loop_blok2_2:
            ...
            # save data for this loop
            trials_19.saveAsExcel(filename + '.xlsx', sheetName='trials_19',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            for thisTrial_21 in trials_21:
                ...
                # save data for this loop
                trials_20.saveAsExcel(filename + '.xlsx', sheetName='trials_20',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            # save data for this loop
            trials_21.saveAsExcel(filename + '.xlsx', sheetName='trials_21',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_blok2_2.saveAsExcel(filename + '.xlsx', sheetName='loop_blok2_2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_5_2 in loop_5_2:
            ...
            # save data for this loop
            trials_22.saveAsExcel(filename + '.xlsx', sheetName='trials_22',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            for thisTrial_24 in trials_24:
                ...
                # save data for this loop
                trials_23.saveAsExcel(filename + '.xlsx', sheetName='trials_23',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            # save data for this loop
            trials_24.saveAsExcel(filename + '.xlsx', sheetName='trials_24',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_5_2.saveAsExcel(filename + '.xlsx', sheetName='loop_5_2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_blok1_2 in loop_blok1_2:
            ...
            # save data for this loop
            trials_25.saveAsExcel(filename + '.xlsx', sheetName='trials_25',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            for thisTrial_27 in trials_27:
                ...
                # save data for this loop
                trials_26.saveAsExcel(filename + '.xlsx', sheetName='trials_26',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            # save data for this loop
            trials_27.saveAsExcel(filename + '.xlsx', sheetName='trials_27',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_blok1_2.saveAsExcel(filename + '.xlsx', sheetName='loop_blok1_2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        for thisLoop_blok3_2 in loop_blok3_2:
            ...
            # save data for this loop
            trials_28.saveAsExcel(filename + '.xlsx', sheetName='trials_28',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            for thisTrial_30 in trials_30:
                ...
                # save data for this loop
                trials_29.saveAsExcel(filename + '.xlsx', sheetName='trials_29',
                    stimOut=params,
                    dataOut=['n','all_mean','all_std', 'all_raw'])
            ...
            # save data for this loop
            trials_30.saveAsExcel(filename + '.xlsx', sheetName='trials_30',
                stimOut=params,
                dataOut=['n','all_mean','all_std', 'all_raw'])
        ...
        # save data for this loop
        loop_blok3_2.saveAsExcel(filename + '.xlsx', sheetName='loop_blok3_2',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
    ...
    # save data for this loop
    condition2.saveAsExcel(filename + '.xlsx', sheetName='condition2',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
